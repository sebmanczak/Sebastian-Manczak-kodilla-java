...
public class ShapeFactoryTestSuite {
    ...
    public void testFactoryCircle() {
        ...
        System.out.println(circle.getArea() + "  " + circle.getName());
    }
    @Test
    public void testFactorySquare() {
        ...
        System.out.println(square.getCircumference() + "  " + square.getName());
    }
    @Test
    public void testFactoryRectangle() {
        ...
        System.out.println(rectangle.getArea() + "  " + rectangle.getName());
    }
}
